...
public class abfksonve extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (!txtNomeEstudante.getText().isBlank() && cmbTurma.getSelectedIndex() > 0 && cmbAvaliativa.getSelectedIndex() > 0) {
            ...
            JOptionPane.showMessageDialog(this, "Os campos Nome Completo, Turma e Avaliativa são obrigatórios.");
        }
    ...
    private void saveToRegFile(int idGerado, String nomeEstudante, String turmaEstudante, String avaliativa, String codigoSegurancaProjeto, String pastaAtualProjeto,
            Date dataRegistro, Time horaRegistro, String codigoMaquina) {
        String x = "";
        String y = "";
        String w = "";
