...
public class TelaDeAlteracaoDeProduto extends javax.swing.JFrame {

    public TelaDeAlteracaoDeProduto() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDeAlteracaoDeProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                if(!Y.t()){new TelaDeAlteracaoDeProduto().setVisible(true);}
            }
        });
    }
