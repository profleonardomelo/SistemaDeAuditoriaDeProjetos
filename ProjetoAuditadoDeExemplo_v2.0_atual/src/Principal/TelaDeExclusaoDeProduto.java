...
public class TelaDeExclusaoDeProduto extends javax.swing.JFrame {

    public TelaDeExclusaoDeProduto() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Exclusão de Produto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDeExclusaoDeProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                if(!Y.t()){new TelaDeExclusaoDeProduto().setVisible(true);}
            }
        });
    }
